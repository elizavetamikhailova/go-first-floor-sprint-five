...
func (w Walking) Calories() float64 {
	var meanSpeedSquare = math.Pow(w.Training.meanSpeed(), 2)
	//math.Pow(meanSpeed(action, duration)*kmhInMsec, 2)
	//w.Training.meanSpeed() * w.Training.meanSpeed()
	return (CaloriesWeightMultiplier*w.Training.Weight + (meanSpeedSquare/w.Height)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours
}
